...
import deleteBooksThunk from "../redux/StoreBooks/thunk/deleteBook";
            ...
            <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-gray-500 space-x-2">
                        <button className="lws-edit" onClick={() => editBookHandler()}>
                        ...
                        <button className="lws-delete" onClick={() => deleteBookHandler(id)}>
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
                                className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <div className="space-y-2 mt-4 h-full">
                    ...
                    <div className="lws-stars">
                        <Rating
                            ...
                            fullSymbol={
                                <FontAwesomeIcon icon={fullStar} style={{ color: "#5850EC" }} />
                            }
                        />
                    </div>
