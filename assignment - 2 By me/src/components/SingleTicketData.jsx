...
import { cancleFlight } from '../redux/BookTicketAndCancle/actions';

const SingleTicketData = ({ticketData}) => {

    const dispatch = useDispatch();

    const {from, to, date, guest, ticketClass, id} = ticketData;

    const deleteTicket =(value)=>{
        dispatch(cancleFlight(value))
    }
    ...
    return (
        ...
        <div className="flex justify-center gap-4">
            <button className="lws-remove" onClick={()=>deleteTicket(id)}>
...
export default SingleTicketData;